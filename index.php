      ...
      <div class="row" style="margin-top: 40px">
        <div class="col-3" style=" margin-left: 10px;">
          <div class=" card-home" style="width: 320px; ">
            ...
            <img style="height: 300px;" src="Assets/Images/Rectangle 4.png" alt="" />
        ...
        <div class="col-3" style="  margin-left: 70px;">
          <div class="card-home" style="width: 320px; ">
            <div class="rating">4.5</div>
            <div class="price">Rp. 200.000/malam</div>
            <img style="height: 300px;" src="Assets/Images/Rectangle 3.png" alt="" />
            <div class="layer-shadow">
              <h5>Ocean Land</h5>
              <h7>Bandung, Indonesia</h7>
            </div>
        ...
        <div class="col-3" style=" margin-left: 70px;">
          <div class="card-home" style="width: 320px; ">
            <div class="rating">4.5</div>
            <div class="price">Rp. 200.000/malam</div>
            <img style="height: 300px;" src="Assets/Images/Rectangle 5.png" alt="" />
            <div class="layer-shadow">
              <h5>Ocean Land</h5>
              <h7>Bandung, Indonesia</h7>
            </div>
  ...
  <main class="container news">
    ...
    <div class="card mb-3 align-content-center" style="max-width: 800px;  margin-top: 40px; border: 0cm;">
      <div class="row no-gutters">
        <div class="col-md-8">
          <div class=" card-body">
            <h1 class="card-title fw-bold">Hotel's Latest Promo</h1>
            <p class="card-text text-muted">We provide what you need, with a new atmosphere and
              year-end promos making
              unforgettable moment of your
              vacation.</p>
            <del>
              <h3 class="card-text text-danger my-1">Rp. 100.000 / Malam</h3>
            </del>
            <h3 class="card-text text-primary my-2" style="text-indent: 30px;">Rp. 60.000 / Malam</h3>
            <a href="detail-hotel.php" class="btn btn-lg btn-warning shadow-sm my-4" style="margin-left: 90px;">Check
              Now</a>
          </div>
        </div>
        <div class="col-4 ">
          <div class=" card-news" style="width:600px; height: 370px; border-top-left-radius: 100px;">
            <div class="diskon">40%</div>
            <div class="price">Rp. 200.000/malam</div>
            <img style="height: 400px;" src="Assets/Images/Rectangle 3.png" alt="" />
            <div class="layer-shadow">
              <h5>Ocean Land</h5>
              <h7>Bandung, Indonesia</h7>
            </div>
      ...
      <div class="row" style="margin-top: 40px">
        <div class="col-3">
          <div class="card-home" style="width: 320px;">
            ...
            <div class="price">Rp. 200.000/malam</div>
            <img style="height: 320px;" src="Assets/Images/Rectangle 4.png" alt="" />
            <div class="layer-shadow">
              <h5>Ocean Land</h5>
              <h7>Bandung, Indonesia</h7>
            </div>
        ...
        <div class="col-3">
          <div class="card-home" style="width: 320px; margin-left: 108px">
            <div class="rating">15%</div>
            <div class="price">Rp. 200.000/malam</div>
            <img style="height: 320px;" src="Assets/Images/Rectangle 3.png" alt="" />
            <div class="layer-shadow">
              <h5>Ocean Land</h5>
              <h7>Bandung, Indonesia</h7>
            </div>
        ...
        <div class="col-3">
          <div class="card-home" style="width: 320px; margin-left: 190px">
            <div class="rating">20%</div>
            <div class="price">Rp. 200.000/malam</div>
            <img style="height: 320px;" src="Assets/Images/Rectangle 5.png" alt="" />
            <div class="layer-shadow">
              <h5>Ocean Land</h5>
              <h7>Bandung, Indonesia</h7>
            </div>
